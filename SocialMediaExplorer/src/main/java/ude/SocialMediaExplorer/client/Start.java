...
import ude.SocialMediaExplorer.server.DataHelperServiceImpl;
...
public class Start implements EntryPoint {
	...
	private IDataHelperServiceAsync dataHelperService = GWT.create(IDataHelperService.class);
	
	public void onModuleLoad() {

		MainPage mainpage = new MainPage();
		dataHelperService.getConfigHashtags(new DataHelperCallback(mainpage));
