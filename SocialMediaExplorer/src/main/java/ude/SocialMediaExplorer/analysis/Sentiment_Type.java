...
public class Sentiment_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ude.SocialMediaExplorer.analysis.Sentiment");
  ...
  public boolean getPositive(int addr) {
      ...
      jcas.throwFeatMissing("positive", "ude.SocialMediaExplorer.analysis.Sentiment");
